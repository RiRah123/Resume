...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Implementing a browsable graph visualization that enables users to seamlessly comprehend the intricate connections among 20,000+ HP-related API entities spanning across 15 distinct types}
        \resumeItem{Deploying the graph on the global hp.dev catalog site, which delivers significant time savings for $\sim$7,000 employees by eliminating the need for manual searches of entity relations across multiple catalogs}
        ...
        \resumeItem{Leading demos of the visualization to managers during sprints, using Scrum to assess their needs and achieve stakeholder satisfaction}
      \resumeItemListEnd
