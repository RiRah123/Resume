...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Transformed complex API data into actionable insights with several Chart.js visualizations, enabling performance assessment of top 10 organizations, enterprise units, and endpoints}
    ...
    \resumeSubHeadingListStart
        ...
        \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{Integrated site with the WebSocket protocol to efficiently preserve user states and game statistics across 25+ sessions, leading to an improved collaboration and heightened user engagement}
          \resumeItemListEnd
